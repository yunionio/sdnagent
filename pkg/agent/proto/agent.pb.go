...
func (*Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_agent_95c92b7b8ab8fa1d, []int{0}
}
...
func (*AddBridgeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_agent_95c92b7b8ab8fa1d, []int{1}
}
...
func (*DelBridgeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_agent_95c92b7b8ab8fa1d, []int{2}
}
...
func (*AddBridgePortRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_agent_95c92b7b8ab8fa1d, []int{3}
}
...
func (*DelBridgePortRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_agent_95c92b7b8ab8fa1d, []int{4}
}
...
func (*AddFlowRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_agent_95c92b7b8ab8fa1d, []int{5}
}
...
func (*DelFlowRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_agent_95c92b7b8ab8fa1d, []int{6}
}
...
func (*SyncFlowsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_agent_95c92b7b8ab8fa1d, []int{7}
}
...
func (*Flow) Descriptor() ([]byte, []int) {
	return fileDescriptor_agent_95c92b7b8ab8fa1d, []int{8}
}
...
func (*PortStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_agent_95c92b7b8ab8fa1d, []int{9}
}
...
func (*DumpBridgePortRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_agent_95c92b7b8ab8fa1d, []int{10}
}
...
func (*DumpBridgePortResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_agent_95c92b7b8ab8fa1d, []int{11}
}
...
func init() {
	...
	proto.RegisterType((*AddBridgeRequest)(nil), "proto.AddBridgeRequest")
	proto.RegisterType((*DelBridgeRequest)(nil), "proto.DelBridgeRequest")
	proto.RegisterType((*AddBridgePortRequest)(nil), "proto.AddBridgePortRequest")
	proto.RegisterType((*DelBridgePortRequest)(nil), "proto.DelBridgePortRequest")
	proto.RegisterType((*AddFlowRequest)(nil), "proto.AddFlowRequest")
	proto.RegisterType((*DelFlowRequest)(nil), "proto.DelFlowRequest")
	proto.RegisterType((*SyncFlowsRequest)(nil), "proto.SyncFlowsRequest")
	proto.RegisterType((*Flow)(nil), "proto.Flow")
	proto.RegisterType((*PortStats)(nil), "proto.PortStats")
	proto.RegisterType((*DumpBridgePortRequest)(nil), "proto.DumpBridgePortRequest")
	proto.RegisterType((*DumpBridgePortResponse)(nil), "proto.DumpBridgePortResponse")
}
...
func (c *vSwitchClient) AddBridge(ctx context.Context, in *AddBridgeRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/proto.VSwitch/AddBridge", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vSwitchClient) DelBridge(ctx context.Context, in *DelBridgeRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/proto.VSwitch/DelBridge", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vSwitchClient) AddBridgePort(ctx context.Context, in *AddBridgePortRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/proto.VSwitch/AddBridgePort", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vSwitchClient) DelBridgePort(ctx context.Context, in *DelBridgePortRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/proto.VSwitch/DelBridgePort", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _VSwitch_AddBridge_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.VSwitch/AddBridge",
	}
...
func _VSwitch_DelBridge_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.VSwitch/DelBridge",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _VSwitch_AddBridgePort_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.VSwitch/AddBridgePort",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _VSwitch_DelBridgePort_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.VSwitch/DelBridgePort",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (c *openflowClient) AddFlow(ctx context.Context, in *AddFlowRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/proto.Openflow/AddFlow", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *openflowClient) DelFlow(ctx context.Context, in *DelFlowRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/proto.Openflow/DelFlow", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *openflowClient) SyncFlows(ctx context.Context, in *SyncFlowsRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/proto.Openflow/SyncFlows", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *openflowClient) DumpBridgePort(ctx context.Context, in *DumpBridgePortRequest, opts ...grpc.CallOption) (*DumpBridgePortResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.Openflow/DumpBridgePort", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Openflow_AddFlow_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Openflow/AddFlow",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Openflow_DelFlow_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Openflow/DelFlow",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Openflow_SyncFlows_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Openflow/SyncFlows",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Openflow_DumpBridgePort_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Openflow/DumpBridgePort",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func init() { proto.RegisterFile("agent.proto", fileDescriptor_agent_95c92b7b8ab8fa1d) }

var fileDescriptor_agent_95c92b7b8ab8fa1d = []byte{
	// 472 bytes of a gzipped FileDescriptorProto
	,
}
